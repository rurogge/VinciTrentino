<div class="answers index">
	...
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $this->Html->link($answer['Question']['text'], array('controller' => 'questions', 'action' => 'view', $answer['Question']['id'])); ?>
		</td>
		<td><?php echo $answer['Answer']['text']; ?>&nbsp;</td>
		<td><?php echo $answer['Answer']['correct']; ?>&nbsp;</td>
		<td class="actions">
