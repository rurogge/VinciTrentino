<div class="regions index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('num_inhabitants');?></th>
			<th><?php echo $this->Paginator->sort('num_cities');?></th>
			<th><?php echo $this->Paginator->sort('num_provinces');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $region['Region']['region']; ?>&nbsp;</td>
		<td><?php echo $region['Region']['num_inhabitants']; ?>&nbsp;</td>
		<td><?php echo $region['Region']['num_cities']; ?>&nbsp;</td>
		<td><?php echo $region['Region']['num_provinces']; ?>&nbsp;</td>
		<td class="actions">
